function result = per_loc_tend_w_bin_cen(bin_cen, n_pt, n_event, event_loc_xy, provided_label_mat, loc_cover_mat)

n_bin = length(bin_cen);
...
%     hist(v_dist_record{i});
    ...
    % hist
    [nele_r,xcen_r] = hist(r_dist_record{i}, bin_cen);
    % prob
